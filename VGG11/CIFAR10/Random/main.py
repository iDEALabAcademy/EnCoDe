...
def main():
    ...
    parser.add_argument('--train_epochs', type=int, default=150, help='Number of epochs to train')
    ...
    for split in splits:
        ...
        FE = VGGFeature()
        classifier = VGGClassifier(num_classes=args.num_classes)
        ...
        FE, classifier = train_models(args, FE, classifier, querry_dataloader, val_dataloader, unlabeled_dataloader, logger)
        ...
        torch.save(FE.state_dict(), os.path.join(save_path, f'{args.dataset}_fe_{args.expt}_{split}.pth'))
