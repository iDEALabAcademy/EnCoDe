...
def main():
    ...
    for split in splits:
        ...
        orig_model = VGG(num_classes=args.num_classes)

        orig_model.load_state_dict(torch.load('/home/rrgaire/projects/icmla2023/vgg/cifar10/single/checkpoints/CIFAR10_vgg_single_model.pth'))
