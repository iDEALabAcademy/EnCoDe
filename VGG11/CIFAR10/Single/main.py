...
def main():
    ...
    task_model = CompVGG(num_classes=args.num_classes)
    task_model.load_state_dict(torch.load('/home/rrgaire/projects/icmla2023/vgg/cifar10/single/checkpoints/CIFAR10_compvgg_single_model.pth'))

    # task_model = torchvision.models.vgg11(pretrained=True)

    # task_model.classifier[6] = torch.nn.Linear(4096, 10)

    # task_model.load_state_dict(torch.load('/home/rrgaire/projects/icmla2023/vgg/cifar10/single/checkpoints/CIFAR10_vgg_pretrained_single_model.pth'))
    ...
    print(f'Test loss: {eval_loss:.8%}, Test Accuracy: {eval_accuracy:.4%}. Inference Time: {time_elapsed}')
