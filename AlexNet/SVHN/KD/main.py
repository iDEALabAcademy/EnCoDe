...
def main():
    ...
    parser.add_argument('--train_epochs', type=int, default=200, help='Number of epochs to train')
    ...
    for split in splits:
        ...
        orig_model.load_state_dict(torch.load('/home/rrgaire/projects/icmla2023/alexnet/svhn/single/checkpoints/SVHN_alexnet_single_model.pth'))

        FE = CompFeatureExtractor()
        FE.load_state_dict(torch.load('/home/rrgaire/projects/icmla2023/alexnet/svhn/kd/checkpoints/SVHN_fe_model_0.1.pth', map_location='cpu'))
        classifier = CompClassifier(num_classes=args.num_classes)
        classifier.load_state_dict(torch.load('/home/rrgaire/projects/icmla2023/alexnet/svhn/kd/checkpoints/SVHN_classifier_model_0.1.pth', map_location='cpu'))
